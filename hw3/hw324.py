...
def get_train_data():
    images = np.zeros(shape = [num_files_train * image_batch, size, size, channels], dtype = float)
    labels = np.zeros(shape = [num_files_train * image_batch], dtype = int)
    start = 0
